...
namespace FriendTagBackend.Migrations
{
    ...
    [Migration("20250523185123_Phone change")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FriendTagBackend.src.Models.Message.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FriendTagBackend.src.Models.Message.Message", b =>
                {
                    b.HasOne("FriendTagBackend.src.Models.User.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FriendTagBackend.src.Models.User.User", "Sender")
                        .WithMany()
